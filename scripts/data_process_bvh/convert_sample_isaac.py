...
def run(in_file: str, out_file: str):
    ...
    for key_name in tqdm(amass_data.keys()):
        ...
        for idx in range(num):
            ...
            smpl_local_robot.load_from_skeleton(betas=None, gender=gender_number, objs_info=None)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_file", type=str, default="/data/soumya/mixamo_out/bvh_copycat_take6_train.pkl")
    parser.add_argument("--out_file", type=str, default="/data/soumya/mixamo_out/bvh_isaac_im_train_take6_upright_slim.pkl")
