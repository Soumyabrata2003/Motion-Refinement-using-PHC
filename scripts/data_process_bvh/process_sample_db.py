...
def fix_height_smpl_vanilla(pose_aa, th_trans, th_betas, gender, seq_name):
    ...
    verts, jts = smpl_parser.get_joints_verts(pose_aa[0:1], th_betas=None, th_trans=th_trans[0:1])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", type=str, default="/data/soumya/mixamo_out/bvh_db_smplh.pt")
    ...
    smpl_parser_n = SMPL_Parser(model_path="/data/soumya/smpl", gender="neutral", use_pca=False, create_transl=False)
    smpl_parser_m = SMPL_Parser(model_path="/data/soumya/smpl", gender="male", use_pca=False, create_transl=False)
    smpl_parser_f = SMPL_Parser(model_path="/data/soumya/smpl", gender="female", use_pca=False, create_transl=False)
    ...
    joblib.dump(train_data, f"/data/soumya/mixamo_out/bvh_{take_num}_train.pkl")
    joblib.dump(test_data, f"/data/soumya/mixamo_out/bvh_{take_num}_test.pkl")
    joblib.dump(valid_data, f"/data/soumya/mixamo_out/bvh_{take_num}_valid.pkl")